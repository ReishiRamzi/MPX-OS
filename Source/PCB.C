...
*/
char* Search_PCB (pcb *pcbPtr, char pcbname[9]){
    char addr = '\0';
    pcb *temp = pcbPtr;
    while (temp != '\0'){
...
*/
int Free_PCB (pcb *pcbPtr, char addr){
    int returnInt = -1;
    pcb *temp = pcbPtr;
    while (temp != '\0'){
...
/*
    ...
    -4: Invalid suspend
*/
int Build_PCB (char addr, char name, int type, int state, int suspend){
    int returnInt = 0;
    int addrCheck = 0;
    pcb *temp = PCB_list;
...
/*
    ...
    -2: Incorrect addr
*/
int Insert_PCB (pcb *PCB_Q, char addr, int method){
    int returnInt;
    pcb *temp = PCB_list;
    pcb *tempQ = PCB_Q;
    while (temp != '\0'){ // make sure the addr exists
...
*/
int Remove_PCB (pcb *PCB_Q, char addr){
    int returnInt;
    pcb *tempQ = PCB_Q;
